...
class SectionIcons {
    @available(iOS 13.0, *)
    public static func sectionIcon(to cell: UITableViewCell, with symbolName: String, backgroundColor: UIColor) {
    ...
    public static func sectionImage(to cell: UITableViewCell, with originalImage: UIImage, size: CGSize = CGSize(width: 52, height: 52), radius: Int = 12) {
    ...
    public static func loadSectionImageFromURL(from url: URL, for cell: UITableViewCell, at _: IndexPath, in _: UITableView) {
    ...
    public static func loadImageFromURL(from url: URL, completion: @escaping (UIImage?) -> Void) {
        let request = ImageRequest(url: url)
